...
<div className="space-y-10">
  ...
  <section className="space-y-5">
    ...
    <div className="rounded-2xl border border-black/10 bg-black/5 p-4 dark:border-white/10 dark:bg-white/5">
      ...
      <pre className="not-prose mt-3 overflow-x-auto whitespace-pre rounded-2xl border !border-zinc-200 !bg-zinc-50 px-4 py-3 font-mono text-sm leading-relaxed !text-zinc-900 dark:!border-zinc-800 dark:!bg-zinc-900 dark:!text-zinc-100">
